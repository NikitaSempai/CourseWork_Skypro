...
public class Main {
    public static Employee employeeDepartmentSalary = null;
    ...
    public static void departmentMinSalary(int departmentNumber) {
        ...
        for (Employee employee : employee) {
            if (employee.getDepartmentNumber() == departmentNumber) {
                if (employeeDepartmentSalary == null || employee.getEmployeeSalary() < employeeDepartmentSalary.getEmployeeSalary()) {
